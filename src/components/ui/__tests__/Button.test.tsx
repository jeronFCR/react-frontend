...
describe('Button component', () => {
  ...
  it('should call the onClick when clicked', () => {
    ...
    const { getByText } = render(<Button onClick={onClickMock}>Click Test</Button>);
