...
describe('RoomDetail', () => {
  ...
  it('should render a loading state with a skeleton', () => {
    i18nRender(
      <Router>
        <RoomDetail loading={true} room={undefined} selectDevice={mockSelectDevice} handleRoomAction={mockHandleRoomAction} />
      </Router>
    );
  ...
  it('should render when room is undefined and show a fallback message', () => {
    i18nRender(
      <Router>
        <RoomDetail loading={false} room={undefined} selectDevice={mockSelectDevice} handleRoomAction={mockHandleRoomAction} />
      </Router>
    );
  ...
  it('should render room details when room data is provided', () => {
    i18nRender(
      <Router>
        <RoomDetail loading={false} room={mockRoom} selectDevice={mockSelectDevice} handleRoomAction={mockHandleRoomAction} />
      </Router>
    );
